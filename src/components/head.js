...
import appleIcon114x144 from '@images/favicons/apple-icon-114x114.png';
...
const Head = ({ metadata }) => (
  <Helmet>
    ...
    <link rel="canonical" href="https://kubasterba.cz" />
    ...
    <link rel="apple-touch-icon" sizes="114x114" href={appleIcon114x144} />
